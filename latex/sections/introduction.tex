...
\textbf{Learning Delta} & \textbf{+0.172} \\
\bottomrule
\end{tabular}
\caption{Learning delta across 308 clean sessions.}
\label{tab:learning-delta-intro}
\end{table}

Filtering to 308 clean sessions (excluding default assessments and incomplete workflows), \textbf{91.3\% showed knowledge improvement}. This is not calibration error being corrected. This is learning being measured.
...
\begin{enumerate}
    ...
    \item \textbf{Empirical}: We present 82,380 observations demonstrating that AI capability genuinely increases during task execution through investigation---the learning delta is real, not an artifact of assessment correction. 91.3\% of clean sessions show knowledge improvement.

    \item \textbf{Practical}: We introduce Empirica, an open-source framework implementing epistemic gates, self-assessment vectors, and calibration loops. The framework is production-tested across 849 sessions.
