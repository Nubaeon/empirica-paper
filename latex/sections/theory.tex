...
The noetic-praxic distinction extends beyond phases of cognition to the \emph{artifacts} each phase produces. We identify five artifact layers, organized by their role in the epistemic lifecycle:
...
\bottomrule
\end{tabular}
\caption{Artifact taxonomy: five layers organized by role in the epistemic lifecycle.}
...
\begin{itemize}
    \item \textbf{Noetic artifacts} are breadcrumbs left during investigation. Six types capture the full investigation record: what was learned (findings), what remains unclear (unknowns), what failed (dead-ends), what went wrong (mistakes), what was consistently missed (blindspots, identified through grounded verification gaps), and what endures across sessions (lessons, durable insights subject to decay when contradicted by new evidence). These persist across sessions and accumulate into institutional memory.
...
The complete measurement cycle---an \textbf{epistemic transaction}---produces artifacts from all layers: PREFLIGHT captures epistemic state, investigation produces noetic artifacts, execution produces praxic artifacts, POSTFLIGHT captures updated state, and POST-TEST collects grounded evidence. The transaction is the atomic unit of calibration.
...
These claims are empirically testable. \Cref{sec:results} presents evidence from 479,686 observations across 638 sessions.
