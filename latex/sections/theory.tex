...
\begin{itemize}
    \item \textbf{Noetic artifacts} are breadcrumbs left during investigation. They capture what was learned (findings), what remains unclear (unknowns), what failed (dead-ends), and what went wrong (mistakes). These persist across sessions and accumulate into institutional memory.
    \item \textbf{Praxic artifacts} are the products of action---code committed, goals completed, subtasks resolved. They serve as objective evidence for grounded verification.
